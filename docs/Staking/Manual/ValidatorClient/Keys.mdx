...
1. Physically disconnect the computer that you use to generate the 24-word mnemonic seed from the Internet.
2. Generate the mnemonic seed.

If you are creating a staking node on Mainnet, for increased security:

1. Copy the software that you need to generate the 24-word mnemonic seed to a USB stick.
2. Start your computer using a bootable USB stick to load the operating system.
