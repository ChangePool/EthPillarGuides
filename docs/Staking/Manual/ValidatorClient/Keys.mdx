...
If you are creating a staking node on Hoodi testnet, then physically disconnect your computer from the Internet prior to generating the 24-word mnemonic seed for the validator.

If you are creating a staking node on Mainnet, for increased security start your computer using a bootable USB stick to load the operating system, and then disconnect the computer from the Internet prior to generating the mnemonic seed.
