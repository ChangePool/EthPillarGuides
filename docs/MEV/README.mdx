...
When adding a new line, notice that the last character in the previous lines must be a backslash (`\`)
...
After configuring your consensus client and validator to enable MEV-Boost, reload and restart your services. Finally, verify your logs look error-free and show use of the new MEV configurations.
...
No changes needed. MEV-Boost only makes outgoing tcp calls.
