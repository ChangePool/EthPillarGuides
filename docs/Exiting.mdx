...
sidebar_position: 90
description: "How to remove a validator from staking duties"
---
...
Voluntary exit procedures involve multiple steps and potential delays. For a complete overview of these steps and delays, refer to _Figure 1_.

<figure>
  <img src={useBaseUrl('img/ExitTimeline.png')} />
  <figcaption>Figure 1 Timeline For a Voluntary Exit by Ladislaus</figcaption>
</figure>
...
<table class="box">
  <tbody>
    <tr>
      ...
      <td class="boxText"><p class="boxText">Following the procedures improves staking network health.</p></td>
    </tr>
  </tbody>
</table>
...
* [Ethereum's Activation and Exit Queues](https://liquidcollective.io/eth-activations-and-exits/)
* [Lighthouse Book: Voluntary Exits (Full Withdrawals)](https://lighthouse-book.sigmaprime.io/validator_voluntary_exit.html)
* [Lodestar Documentation: validator voluntary-exit](https://chainsafe.github.io/lodestar/run/validator-management/validator-cli#validator-voluntary-exit)
* [The Nimbus Guide: Perform a Voluntary Exit](https://nimbus.guide/voluntary-exit.html)
* [Prysm Documentation: Exit Your Validator](https://docs.prylabs.network/docs/wallet/exiting-a-validator)
* [Teku Documentation: Voluntarily Exit a Validator](https://docs.teku.consensys.net/how-to/voluntarily-exit)
