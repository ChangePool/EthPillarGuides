...
## ⏱️ Timeline For a Voluntary Exit



<img src={useBaseUrl('img/exit-timeline.png')} alt=""/><p>Voluntary exit procedures involve multiple steps and potential delays. For a complete overview of these steps and delays, refer to Ladislaus's informative graphic.</p>
